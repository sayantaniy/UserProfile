...
const basicinfo = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className='flex flex-col sm:m-1 rounded-4xl p-10 m-8 c1 b1'
    >
      <motion.h1
        initial={{ opacity: 0, x: -30 }}
        whileInView={{ opacity: 1, x: 0 }}
        transition={{ delay: 0.2, duration: 0.5 }}
        className='font-bold font-comic text-5xl lg-text-6xl t4 underline'
      >
        basic info
      </motion.h1>
      ...
      <motion.p
        ...
        className='font-dmserif lg:text-2xl t6 mt-5'
      >
